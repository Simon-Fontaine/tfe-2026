							...
							{conversations.map((conversation) => {
								...
								return (
									...
									>
										...
										<Link
											href={`${dashboardRoutes.teams.recruitingConversations(team.id)}?thread=${conversation.threadId}`}
											className={`block px-3 pb-3 pt-1 hover:bg-muted/50 ${isSelected ? "bg-primary/5" : ""}`}
										>

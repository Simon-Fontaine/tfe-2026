...
export default async function TeamPostsPage({ params }: { params: Promise<{ teamId: string }> }) {
				...
				<div className="space-y-4">
					{team.ownedPosts.map((post) => (
						<RecruitmentPostCard
							...
							conversationHrefBase={dashboardRoutes.teams.recruitingConversations(team.id)}
						/>
					))}
				</div>
			)}
